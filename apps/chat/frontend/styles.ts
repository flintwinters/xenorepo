...
export const chatStyles = css`
  ...
  * {
  ...
  .mosaic {
    min-height: 0;
    display: grid;
    grid-template-columns: 176px minmax(360px, 1fr) 220px;
  ...
  .notice {
    ...
    color: #a89984;
    background: #181a1b;
    border: 1px inset #504945;
  }
  .messages {
    height: 100%;
    overflow-y: auto;
    background: linear-gradient(#171918, #202320);
  ...
  @media (max-width: 850px) {
    .mosaic {
      grid-template-columns: 165px minmax(330px, 1fr);
    }
    .details {
      display: none;
    }
  ...
  @media (max-width: 570px) {
    ...
    .compose-form {
      grid-template-columns: 108px minmax(0, 1fr) 60px;
