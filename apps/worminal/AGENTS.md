...
Define the user outcome and the smallest real-world journey that proves Worminal is useful.
...
Worminal owns its product behavior and consumes generic Monotools contracts from the enclosing
...
- Replace the walking-skeleton specification and acceptance journey with proved product behavior.
