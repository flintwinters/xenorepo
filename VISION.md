...
| Frontend system | Self-contained strict Preact TSX artifacts build through the platform, with a restrained typed shared primitive layer. | Extract only genuinely reusable components into the catalog while preserving app-owned product boundaries. |
